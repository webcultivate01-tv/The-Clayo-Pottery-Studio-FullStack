-- ============================================================================
-- Clayo Pottery Studio Management System — MySQL Schema
...
CREATE DATABASE IF NOT EXISTS `Clayo-Pottery-Studio`
    DEFAULT CHARACTER SET utf8mb4
    DEFAULT COLLATE utf8mb4_unicode_ci;

USE `Clayo-Pottery-Studio`;
...
-- ----------------------------------------------------------------------------
-- popups — promotional modals shown on the public website
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- gallery_images — website gallery, managed from the admin panel
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- gallery_categories — categories for website gallery
-- ----------------------------------------------------------------------------
...
INSERT INTO `settings` (`key_name`, `value`, `group_name`) VALUES
    ('studio_name',  'Clayo Pottery Studio',  'general'),
    ('studio_email', 'hello@clayo.local', 'general'),
